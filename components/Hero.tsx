...
//   return (
//     <section className=" ">
//       <Container className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
//         <div className="order-2 lg:order-1 mb-16" dir="rtl">
//           <h1 className="text-3xl  md:text-5xl font-black text-primary leading-snug text-right">
//             حسابداری شخصی مانایا
//           </h1>
//           <p className="mt-3 text-2xl font-medium text-text-secondary max-w-xl leading-relaxed text-right">
...
//           <div className="relative w-[500px] h-[674px] ">
//             <Image
...
//             width={600}
//             height={500}
//             className="hidden md:block absolute   top-1/2  left-1/2  drop-shadow-xl"
//           />
//         </div>
//       </Container>
//     </section>
...
//         {/* متن */}
//         <div className="order-2 lg:order-1 space-y-6 text-right" dir="rtl">
...
//               alt="نمایش اپلیکیشن مانایا"
//               fill
//               className="hidden lg:block object-contain drop-shadow-2xl"
//               priority
//             />
//           </div>
