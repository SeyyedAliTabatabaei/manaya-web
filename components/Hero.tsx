...
export default function Hero() {
    ...
    return (
        <section
            className="md:pb-32"
            role="banner"
            aria-label="معرفی اپلیکیشن حسابداری شخصی مانایا"
        >
            <Container className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20">
                ...
                <div className="order-1 lg:order-1 space-y-6 text-right" dir="rtl">
                    ...
                    <div
                        ...
                        role="group"
                        aria-label="لینک‌های دانلود اپلیکیشن مانایا"
                    >
                        <Link
                            href="https://cafebazaar.ir/app/ir.manaya"
                            aria-label="دانلود اپلیکیشن مانایا از کافه بازار"
                        >
                            <Image
                                src={
                                    isDark
                                ...
                                alt="دکمه دانلود اپلیکیشن حسابداری مانایا از کافه بازار"
                                width={160}
                                height={50}
                        ...
                        <Link
                            href="https://myket.ir/app/ir.manaya"
                            aria-label="دانلود اپلیکیشن مانایا از مایکت"
                        >
                            <Image
                                src={
                                    isDark
                                ...
                                alt="دکمه دانلود اپلیکیشن حسابداری مانایا از مایکت"
                                width={160}
                                height={50}
                                className="w-[140px] md:w-[170px] h-auto [&_text]:fill-white"
                            />
                    ...
                    <div className="mt-8 block lg:hidden">
                        <Image
                            ...
                            alt="پیش‌نمایش کارت‌های مالی در اپلیکیشن مانایا (ویژه موبایل)"
                            width={600}
                            height={450}
                ...
                <div className="relative hidden lg:flex order-1 lg:order-2 justify-center">
                    <div className="relative w-[260px] h-[360px] sm:w-[360px] sm:h-[480px] lg:w-[460px] lg:h-[640px]">
                        <Image
                            ...
                            alt="نمایش رابط کاربری اپلیکیشن مانایا در دسکتاپ"
                            fill
                    ...
                    <Image
                        src="/tempImage/heroImg2.png"
                        alt="پیش‌نمایش کارت‌های مالی در اپلیکیشن مانایا (ویژه دسکتاپ)"
                        width={500}
                        height={400}
